    ...
    <div class="block md:hidden">
        ...
        <div class="mb-6">
            <div class="flex justify-between items-center mb-3 px-1">
                ...
                <a href="{{ route('products') }}" class="text-blue-600 text-xs hover:text-blue-800 transition">Lihat Semua &rarr;</a>
            </div>
            <div class="relative">
                    ...
                    <div class="swiper-wrapper">
                        @foreach ($produkTerbaru as $produk)
                            <div class="swiper-slide px-1">
                                <div class="bg-white rounded-lg shadow p-3 w-full max-w-[13rem] mx-auto hover:shadow-md transition relative">
                                    <div class="h-32 mb-1.5 rounded overflow-hidden bg-gray-100 flex items-center justify-center">
                                        @if (!empty($produk->is_preorder))
                                            <div class="absolute top-2 right-2 z-10">
                                                <div class="bg-purple-100 w-10 h-10 rounded-full flex items-center justify-center relative drop-shadow-lg">
                                                    <img src="{{ asset('img/pre-order.png') }}" alt="Pre Order" class="w-4 h-4">
                                                </div>
                                            </div>
                                        @endif
                                    ...
                                    <a href="{{ route('product-detail', $produk->slug) }}"
                                        class="text-blue-600 text-xs hover:text-blue-800 transition block mt-1.5 z-10 relative">Lihat Detail</a>
                                </div>
                            </div>
                        @endforeach
                    </div>
        ...
        <div class="mb-6">
            <div class="flex justify-between items-center mb-3 px-1">
                ...
                <a href="{{ route('brands') }}" class="text-blue-600 text-xs hover:text-blue-800 transition">Lihat Semua &rarr;</a>
            </div>
            <div class="relative">
    ...
    <div class="hidden md:grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="{{ route('products') }}" class="text-blue-600 text-sm hover:text-blue-800 transition">Lihat Semua Produk &rarr;</a>
            </div>
            <div class="relative">
                    ...
                    <div class="swiper-wrapper">
                        @foreach ($produkTerbaru as $produk)
                            <div class="swiper-slide">
                                <div class="bg-white rounded-lg shadow p-4 w-full max-w-[14rem] mx-auto hover:shadow-md transition relative">
                                    <div class="h-36 mb-2 rounded overflow-hidden bg-gray-100 flex items-center justify-center">
                                        @if (!empty($produk->is_preorder))
                                            <div class="absolute top-2 right-2 z-10">
                                                <div class="bg-purple-100 w-12 h-12 rounded-full flex items-center justify-center relative drop-shadow-lg">
        ...
        <div>
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="{{ route('brands') }}" class="text-blue-600 text-sm hover:text-blue-800 transition">Lihat Semua Merek &rarr;</a>
            </div>
            <div class="relative">
                <div class="swiper brandSwiper">
                    <div class="swiper-wrapper">
                        @foreach ($merekAktif as $merek)
                            <div class="swiper-slide">
                                <div class="bg-white rounded-lg shadow p-4 w-full max-w-[14rem] mx-auto hover:shadow-md transition">
